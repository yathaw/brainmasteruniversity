...
if($row['react'] == 1){
    $react = '<span style="color:green;"> like </span> ';
}else{
    $react = '<span style="color:red;"> dislike </span>';
}
...
try {
    ...
    $mail->Subject = "Watch Out For Reacting Idea";
                                            ...
                                            <tr>
                                                <td style="text-align: center;">
                                                    <div class="text-author">
                                                        <img src="cid:profile" alt="" style="width: 100px; max-width: 600px; height: auto; margin: auto; display: block;">
