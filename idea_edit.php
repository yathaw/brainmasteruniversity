<?php 
    ...
    if(isset($_POST["btnsave"]))
    {
        ...
        if($valid){
            ...
            $update = "UPDATE ideas SET title='$title', body='$description', file='$file_path', category_id='$category', status='$anonymousStatus' WHERE id='$id' ";
    ...
    if(isset($_GET['id']))
    {
        ...
        $idea_query=mysqli_query($conn,"SELECT * FROM ideas WHERE id='$id'");  
        $idea_numrows=mysqli_num_rows($idea_query);
        if($idea_numrows > 0){

            $idea_query=mysqli_query($conn,"SELECT * FROM ideas WHERE id='$id' AND user_id='$sess_userid' ");  
            $idea_numrows=mysqli_num_rows($idea_query);
            if($idea_numrows > 0){
                $row = mysqli_fetch_array($idea_query);
                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h5 class="d-inline-block">Edit Existing Idea</h5>
                        </div>
                        <div class="card-body">
                            ...
                            <form action='idea_edit.php' method='POST' class="form-sample" enctype="multipart/form-data">
                                ...
                                <div class="row mb-3">
                                    <div class="col-xl-5 col-lg-5 col-md-6 col-sm-12 col-12 ">
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-12">                                             
                                                ...
                                                <div class="input-group input-group-merge">
                                                    ...
                                                    <input type="text" class="form-control" id="inputTitle" placeholder="Enter Title Here" name="title" value="<?= $title; ?>" />
                                                </div>
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-12">
                                                ...
                                                <select class="select2" id="inputCategory" disabled>
                                                    <option></option>
                                                    <?php 
                                                    ...
                                                    <option value="<?= $category[0]; ?>" 
                                                        <?php if($category[0] == $category_id){ echo 'selected'; } ?>
                                                    > 
                                                        <?= $category[1]; ?> 
                                                    </option>
                                                    <?php endforeach ?>
                                    ...
                                    <div class="col-xl-7 col-lg-7 col-md-6 col-sm-12 col-12 ">
                                        ...
                                        <textarea id="inputBody" name="description" rows="8"><?= $description; ?></textarea>
                                        <span class="text-danger">
                                    ...
                                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                        <div class="col-12">
                                            <div class="form-check form-switch mb-2">
                                                <input class="form-check-input" type="checkbox" id="inputAnonymous" name="anonymous" <?php if($status == 'on'){ echo 'checked'; } ?> />
