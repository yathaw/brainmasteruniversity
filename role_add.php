<?php 
    ...
    if(isset($_POST["btnsave"]))
	{
		...
		$_SESSION['oldvalue']['departmentid'] = $departmentid;
	    ...
	    if($valid){
	    	$position_query=mysqli_query($conn,"SELECT * FROM positions WHERE name LIKE '%$name%' ");  
		    $position_numrows=mysqli_num_rows($position_query); 
		    if($position_numrows <= 0){
		    	
		    	$positions_sql = "INSERT INTO positions(name, department_id) VALUES ('$name', '$departmentid')";
                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                	...
                	<div class="card">
                        <div class="card-header">
                            <h5 class="d-inline-block">Create New Poistion</h5>
                        </div>
                        ...
                        <div class="card-body">
                            ...
                            <form action='role_add.php' method='POST' class="form-sample">
                            	<div class="row mb-3">
                                    <div class="col-12">                                             
                                        ...
                                        <div class="input-group input-group-merge">
                                            ...
                                            <input type="text" class="form-control 
					                            ...
					                            ?>" id="inputName" placeholder="Enter Position Name Here" name="name" autofocus value="<?php if(isset($_SESSION['oldvalue']['name']) && !empty($_SESSION['oldvalue']['name']) ){ echo $_SESSION['oldvalue']['name']; } ?>" />
                                        </div>
                                        ...
                                        <div class="input-group input-group-merge">
                                            ...
                                            <select class="select2" name="departmentid" id="inputDepartmentid">
					                            ...
					                            <option value="<?= $department[0]; ?>" 
                                                        <?php if(isset($_SESSION['oldvalue']['departmentid'])) { 
                                                            if($_SESSION['oldvalue']['departmentid'] == $department[0]) {
                                                                echo "selected"; 
                                                            } 
                                                        } 
                                                        ?> 
